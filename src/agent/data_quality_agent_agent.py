"""Data Quality Agent - Main Agent Implementation."""
...
class DataQualityAgentAgent:
    ...
    def __init__(self):
        ...
        self.quality_rules_enabled = True
        self.anomaly_detection_enabled = True
        self.freshness_monitoring_enabled = True
        self.completeness_checks_enabled = True
        self.quality_scoring_enabled = True
        self._tool_dispatch = {
            "define_expectations": self.tools.define_expectations,
            "run_quality_checks": self.tools.run_quality_checks,
            "detect_anomalies": self.tools.detect_anomalies,
            "measure_freshness": self.tools.measure_freshness,
            "generate_scorecard": self.tools.generate_scorecard,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['quality_rules', 'anomaly_detection', 'freshness_monitoring', 'completeness_checks', 'quality_scoring'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "define_expectations": ['define', 'expectations'],
            "run_quality_checks": ['run', 'quality', 'checks'],
            "detect_anomalies": ['detect', 'anomalies'],
            "measure_freshness": ['measure', 'freshness'],
