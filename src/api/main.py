"""Data Quality Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Data quality monitoring agent that defines and enforces data quality rules, detects anomalies, measures data freshness, validates completeness and accuracy, and generates data quality scorecards.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
